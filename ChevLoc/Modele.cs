        ...
        public void charger_donnees(string table)
        {
            ...
            switch (table)
            {
                ...
                case "equipements":
                    ...
                    break;
                case "logements":
                    charger("select id_logements,rue_logements from logements;", dT[8], dA[8]);
                    break;
                case "motifs":
                ...
                case "proprietaires":
                    ...
                    break;
                case "appartements" :
                    charger("select * from appartements;",dT[22],dA[22]);
                    break;
                case "chambresHabitant":
                    charger("select * from chambresHabitant;", dT[23], dA[23]);
                    break;
                case "illustrer":
                    charger("select * from illustrer;", dT[24], dA[24]);
                    break;
                case "messages":
                    charger("select * from messages;", dT[25], dA[25]);
                    break;
                case "studios":
                    charger("select * from studios;", dT[26], dA[26]);
                    break;
            }
        }
